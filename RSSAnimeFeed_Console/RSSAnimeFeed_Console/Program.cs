...
namespace HTML_Downlaod_Konsole
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //Test_HTML_ReadInput_WriteInput();
        ...
        /// Read HTML file...
        /// </summary>
        public static void Test_HTML_ReadInput_WriteInput()
        {
        ...
        public static void Test_HTML_Downlaod_Picture()
        {
        ...
        public static void TryStackOvebrflow()
        {
            string animeUrl = "https://www.crunchyroll.com/de/fuuto-pi";
